				...
				for (var j = 0; j < items.length; j++) {
					...
					if (innerChildNode.hasAttribute('data-bb-type')) {
						...
						if (type == 'header') {
							...
							innerChildNode.ontouchstart = function () {this.setAttribute('class', this.highlight);}
							innerChildNode.ontouchend = function () {this.setAttribute('class',this.normal);}
						}
						else if (type == 'item') {
				...
				for (j = 0; j < items.length; j++) {
					...
					if (innerChildNode.hasAttribute('data-bb-type')) {
						...
						if (type == 'header') {
							...
							var htmlHeader = '<span >'+ description + '</span>';
    ...
    apply: function(elements) {
            ...
            for (var i = 0; i < elements.length; i++) {
                ...
                if (items.length > 0 ) {
					...
					// Grab the accent-text if it is there
					if (!outerElement.hasAttribute('data-bb-venezuela')) {
