var xhrServicesTest;
var actualDate,idGameCurrent ="",idEventCurrent ="", hourEventCurrent="",alive = "",inningsUp = true,nameShortHome = "",nameShortVisit="", inningsGeneral, carreraHome, carreraVisit;
...
function getNewHighlight(usecache){
	...
	xhrServicesTest = $.ajax({ url: urlS, dataType: 'xml',  async: true, cache: usecache, success: function(result){
					...
					var width = ((window.innerWidth));
						...
						'<div class = "bb-bb10-grid-item-overlay-'+res+'">'+
						...
						if (lenFound == false) {
								...
								if (currenten > len) {
									...
									startVibrate();
									window.plugins.statusBarNotification.notify("Noticia Destacada", $title.text());
					  ...
					  //end update EmphasizeNews notification
					  
					  window.addEventListener("resize", function() {
						  // Get screen size (inner/outerWidth, inner/outerHeight)
							if(stackActivity[indexStackActivity] == "home"){
...
function getGamesDo(result,date){
	...
	game.setAttribute('style', 'background-image: url(\'images/style/campo_modulo.jpg\');');
...
//		  console.log(idGame);
		...
		tdLabel1.innerHTML = strVs+''+stringStatusGame+'\n<div >'+nameStadium+'</div><img  width="100%" src="images/style/linea_amarilla.jpg" />';
		tdLabel1.setAttribute("align","center");
...
//		 game.appendChild(separador);
	 ...
	 console.log("flagDontGame --> "+flagDontGame+"--->"+gameBegin+"");
	 ...
	 if((hoy.getMonth() == date.getMonth()) && (hoy.getDate() == date.getDate()) ){
		...
		if((hoy.getMonth() == date.getMonth()) && (hoy.getDate() == date.getDate()) ){			
			...
			var stringBuilder1 = date.getFullYear()+"-"+month1+"-"+date.getDate();
			console.log(stringBuilder1);
//			style="background-image: url(\'images/style/arrow_container.jpg\');"
				
//			<div id="footer">
//			<span class="clock" id="liveclock"><img id="countId" src="images/tiempo/t_10.png" /></span>
//			<img id="imageMuneco" alt="Muneco" src="images/Mascot_Wenlock.gif" />
//		</div>
			
//			<div style="position:relative">
//				<img src="imagen_debajo.jpg" width="268" hspace="16" height="268" vspace="16" />
//				<div style="position:absolute; top:0; left:0;"><a href="http://www.guiaplaza.com">
...
//			var strDate = '<div style="position:relative" width= "100%"><img src="images/style/arrow_container.jpg" width="100%"/> <div width="100%" style="position:absolute; top:0; left:0;" ><table border="1" width = "100%" ><tr><td align="left" width = "10%">';
//			if(flagHoy){
//				strDate = strDate + ' <img  class ="arrowLeft-'+res+'" id="" alt=""  src="images/arrow_left.png"  onclick="paginationDay(\''+stringBuilder1+'\');" /> ';
//			}
//			strDate = strDate + '</td><td align="center" width= "80%">'+stringBuilder+'</td><td align="right" width = "10%"></td></tr> </table> </div></div>';
//			
//			document.getElementById('date-game').innerHTML = strDate;
//			
			
			var strDate = '<table style="background-image:url(\'images/style/barra_flechas.jpg\');  background-repeat: repeat-x;"  width = "100%" ><tr><td align="left" width = "10%">';
			if(flagHoy){
				strDate = strDate + ' <img  class ="arrowLeft-'+res+'" id="" alt=""  src="images/arrow_left.png"  onclick="paginationDay(\''+stringBuilder1+'\');" /> ';
			}
			...
			strDate = strDate + '</td><td align="center" width= "80%"><b style="font-family: Freshman;">'+stringBuilder+'</b></td><td align="right"  width = "10%"><img class ="arrowLeft-'+res+'" id="" alt="" src="images/arrow_right.png" onclick="paginationDay(\''+stringBuilder2+'\');" /></td></tr> </table>';
			document.getElementById('date-game').innerHTML = strDate;			
		}
...
function setMinuteByMinuteDo(result){
	...
	if(y == 0){
		...
		document.getElementById('red-social').innerHTML = ' <img    class="redSocial-'+res+'" id="menuPrincipalButtonLoser" src="images/sms.png" onclick="shareSMS(\''+escape(comentarioFirts)+'\');"  />'+		
		'<img class="redSocial-'+res+'"  id="reintentarButton" src="images/facebook.png" onclick="facebookWallPost(\' Narración: '+escape(comentarioFirts)+'\',\'Estoy siguiendo el juego desde mi telefono y en el inning '+inningsGeneral+', '+nameShortHome+': '+carreraHome+' y '+nameShortVisit+': '+carreraVisit+' Corre la voz!\',\'http://beisbol.movilnet.com.ve/especiales/facebook/images/estadios/'+nameShortHome.toLowerCase()+'.jpg\',\'http://apps.facebook.com/pasionbeisbol/\' );"/>'+
		'<img  src="images/twitter.png" class="redSocial-'+res+'" onclick="shareTwitter(\''+encodeURIComponent(comentarioFirts)+'\');"  /> ';
	}
		...
		if(i == 0){
				if(currentSlug == idGameCurrent ){
					if((date != hourEventCurrent) ){
						if(flagSoundEvent){
							startVibrate();
							startAudio("/android_asset/www/sounds/"+nameEvent+".mp3");
							window.plugins.statusBarNotification.clear();
...
function setStatusInningsDo(result){
	 ...
	 $(result).find("juego").each(function() {
			...
			$(this).find("diamante").each(function(){
			 ...
			 $(this).find("innings").each(function(){
				 ...
				 if(casa == "None"){
					 inningsUp = true;
					 stringBuilderUp = '<img class ="arrow-'+res+'"  src="images/inning_up.jpg" alt="arrowUp" />';
				 }else{
					 inningsUp= false;
					 stringBuilderUp = '<img class ="arrow-'+res+'"  src="images/inning_down.jpg" alt="arrowDown" />';
				 }  
			 ...
			 $(this).find("estado").each(function(){
					...
					alive = $(this).find("activo").text();
					if(alive == "0"){
						stringStatusGame = '&nbsp;-&nbsp;<b style="color: white;" >'+hour+'</b>';
						casaCarreras = "-";
						visitantesCarreras = "-";
					}else if(alive == "1"){
						stringStatusGame = '&nbsp;-&nbsp;<b style="color: #33ff00;" >En Vivo</b>';
					}else if(alive == "2"){
						stringStatusGame = '&nbsp;-&nbsp;<b style="color: #C01704;"  >Finalizado</b>';  
					}else if(alive == "3"){
						stringStatusGame = '&nbsp;-&nbsp;<b style="color: #C01704;" >Suspendido</b>';
						if(inningNun == 0){
							casaCarreras = "-";
							visitantesCarreras = "-";
							stringStatusGame = stringStatusGame +' &nbsp;<b style="color: white;" >'+hour+'</b>';
						}
					}
	...
	tdLabel1 = document.createElement('td');
	tr.appendChild(tdLabel1);
	tdLabel1.setAttribute("width","21%");
	tdLabel1.setAttribute("align","center");
...
//	tdLabel1.setAttribute("align","center");
//	var stringOuts = (outs > 1) ? "outs" : "out"; 
//	tdLabel1.innerHTML = ''+bolas+"-"+strikes+"&nbsp; "+outs+" "+stringOuts;
...
//						console.log(urlImagen);
						...
						thLabel.innerHTML = '<p  class="textTitle-'+res+'" ><b>'+title+'</b></p>';
						...
						tr.appendChild(thLabel);
						thLabel.innerHTML = '<img src="'+urlImagen+'" class = "imagenNews-'+res+'" /> <p align="justify" class="textIntro-'+res+'"> '+intro+'</p> ';
...
//			    console.log("XML: "+$xml);
				...
				document.getElementById('title-detail').innerHTML = '<b>'+$title.text()+'</b>';
...
//				'&nbsp;<img  src="images/twitter.png" width="32" height="32" onclick="shareTwitter()" />&nbsp;';
				...
				document.getElementById('red-social').innerHTML = '<img   class="redSocial-'+res+'" '+
				...
				'/>&nbsp;<img  src="images/twitter.png" class="redSocial-'+res+'" onclick=\'shareTwitter("'+encodeURIComponent(shareText)+'");\'  /> ';
...
//		 game.appendChild(separador);
	 ...
	 document.getElementById('load-game-resultado').innerHTML = "";
		...
		if((hoy.getMonth() == date.getMonth()) && (hoy.getDate() == date.getDate()) ){
			...
			date.setDate(date.getDate()-1);
			var stringBuilder1 = date.getFullYear()+"-"+date.getMonth()+"-"+date.getDate();
			var strDate = '<table width = "100%" cellspacing ="0" cellpadding="8"  style=" font-family: Freshman; background-image: url(\'images/style/background_boxscore_td.png\');"> <tr><td align="left" width = "10%">';
			if(flagHoy){
				strDate = strDate + ' <img  class ="arrowLeft-'+res+'" id="" alt="" src="images/arrow_left.png" onclick="paginationResutadoDay(\''+stringBuilder1+'\');" />';
			}
			...
			var strDate = '<table  width = "100%"  style=" font-family: Freshman; background-image: url(\'images/style/background_boxscore_td.png\');"><tr><td align="left" width = "10%">';
			if(flagHoy){
				strDate = strDate + '<img class ="arrowLeft-'+res+'"  id="" alt="" src="images/arrow_left.png" onclick="paginationResutadoDay(\''+stringBuilder1+'\');" />';
			}
			strDate = strDate + '</td><td align="center" width= "80%">'+stringBuilder+'</td><td align="right"  width = "10%"><img class ="arrowLeft-'+res+'" id="" alt="" src="images/arrow_right.png" onclick="paginationResutadoDay(\''+stringBuilder2+'\');" /></td></tr> </table>';
			document.getElementById('date-game-resultado').innerHTML = strDate;				
		}
...
function getCalendar(date,page){
	...
	console.log(weeknumber+"----"+stringDate+"--- "+date);
	...
	if(weeknumberSecuencial == '1'){
		...
		'align="right"><img x-blackberry-focusable="true" onmouseover = "this.src = \'images/arrow_right_click.png\'" onmouseout="this.src = \'images/arrow_right.png\'"  class ="arrowLeft-'+res+'" id="" alt="" src="images/arrow_right.png" onclick="paginationCalendarDay(\'2012-09-18\');" /> </td></tr></table>';
	}else{
		...
		stringBuilderDay = '<table width="100%" style="background-image: url(\'images/style/background_boxscore_td.png\');" > <tr><td align="left" width="30%"> <img x-blackberry-focusable="true" onmouseover = "this.src = \'images/arrow_left_click.png\'" onmouseout="this.src = \'images/arrow_left.png\'"  class ="arrowLeft-'+res+'" id="" alt="" src="images/arrow_left.png"    onclick="paginationCalendarDay(\''+stringBackDay+'\');" /></td><td align="center" width="40%" style="color: white;">Semana '+weeknumberSecuencial+'</td><td width="30%" align="right">'+
...
//	console.log("makeTableCalendar - "+list);
	var calendar = document.getElementById('calendarioListId');
	calendar.setAttribute('style', 'background-image: url(\'images/style/campo_modulo.jpg\');');
	var res, fechaGame = "",i = 0, gameBegin = false, hourGameNext="",nameShortVisitNext="",nameShortHomeNext="";
	...
	if(screen.width >= 480 || screen.height >= 480){
	 ...
	 $(list).find("juego").each(function() {
		...
		table.setAttribute('class','customers-'+res);
		  ...
		  $(this).find("global").each(function(){
			 ...
			 if(pastName != dayName){
				 ...
				 div.innerHTML = ""+cleanText(fecha2.substring(0,(fecha2.length)-4)).toUpperCase();
		...
		var strVs = "";
		if(i==0){ strVs = '<img  class ="vs-'+res+'" src="images/home_vs.png" /><br/>';}
		tdLabel1.innerHTML = strVs+'<br/>'+hour+'\n<div >'+nameStadium+'</div><img  width="100%" src="images/style/linea_amarilla.jpg" />';
