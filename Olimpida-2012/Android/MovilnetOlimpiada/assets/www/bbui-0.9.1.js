...
//							innerChildNode.innerHTML = '<p>'+ description +'</p>';
							...
							if(flagNarrative == 1){
								htmlHeader = htmlHeader+'<div class="bb-'+res+'-imagen-list-header-update"><img id="updateGreen" onclick="updateMenuMinute();" src="images/update.png" />&nbsp; &nbsp;<img id="flagVen" onclick="selectVen();" src="images/VEN.png"/></div>';
							}
			...
			for (var i = 0; i < elements.length; i++) {
				...
				for (j = 0; j < items.length; j++) {
					...
					if (innerChildNode.hasAttribute('data-bb-type')) {
						...
						innerChildNode.innerHTML = '<img class = "bb-'+res+'-minuto-images" src="'+ innerChildNode.getAttribute('data-bb-img') +'" />\n'+
										'<div class="details">\n'+
										'   <span class="title">'+innerChildNode.getAttribute('data-bb-title')+':&nbsp;</span>'+stringBuild+' \n'+
										'   <div class="description">' + description + '</div>\n'+
										'   <span class="accent-text">' + accentText + '</span>\n'+
										'</div>\n';
						innerChildNode.removeAttribute('data-bb-img');
