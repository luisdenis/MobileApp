					...
					var width = ((window.innerWidth));
						...
						if (lenFound == false) {
								...
								if (currenten > len) {
									...
									//alert("misma fecha 1 currentLastEmphasizeNewsTitle: "+currentLastEmphasizeNewsTitle);
									//alert("misma fecha 2 title: "+$title.text());
...
function updateMinutoSyncro(){
 ...
 if(stackActivity[indexStackActivity] == "narrative" ){
...
function getMedal(page){
		var urlS= "http://olimpiadas.movidamovil.com/medallero/?page="+page+"&cant=20";
	...
	if(totalPage != 0){
		if(page == totalPage){
			if(page != 1){
				...
				stringBuilder = '<a  x-blackberry-focusable= "true" onmouseover = "this.className = \'aclick-hover\'" onmouseout = "this.className = \'aclick-movilnet\'"  onclick="paginationMedal('+pageBack+');" class= "aclick" >&laquo;&nbsp; Anterior</a>';
			}
		}else if(page == 1 ){
						 ...
						 //find every Tutorial and print the author
						  $(result).find("articulo").each(function()
						  {
							...
							var item,container, news = document.getElementById('news-list');
								...
								item.setAttribute('onclick', "nextActivity('"+sluglocal+"','detailNews')");
							 ...
							 //find every Tutorial and print the author
							  $(result).find("articulo").each(function()
							  {
								...
								var item,container, news = document.getElementById('gd-list');
									...
									item.setAttribute('onclick', "nextActivity('"+sluglocal+"','detailGeneration')");
									item.innerHTML = '' + intro;
									// Create a dummy container
...
function getNewDetail(slug){
	...
	xhrServicesTest = $.ajax({ url: urlS, dataType: 'xml',  async: true, cache:true, success: function(result){
				...
				document.getElementById('red-social').innerHTML = '<a href="http://www.facebook.com/sharer.php?u=contenidos.movilnet.com.ve&t=MovilnetOlimpiada"><img src="images/1339472875_FaceBook_32x32.png" width="32" height="32" /></a>&nbsp;&nbsp;<a href="https://twitter.com/intent/tweet?text=Venezuela Olimpica: '+shareText+'. Mas informacion en &url=contenidos.movilnet.com.ve"><img  src="images/1339470396_Twitter_32x32.png" width="32" height="32" /></a>&nbsp;';
							 ...
							 //find every Tutorial and print the author
							  $(result).find("articulo").each(function()
							  {
								...
								var item,container, news = document.getElementById('discipline-list');
									...
									item.setAttribute('onclick', "nextActivity('"+sluglocal+"','detailDiscipline')");
									item.innerHTML = '' + intro;
									// Create a dummy container
...
function getCalendar(date,page){
	...
	xhrServicesTest = $.ajax({url: urlS, dataType: 'json', async: true, cache:false, success: function(data){
		...
		if(stringDate == '2012-8-12'){
			stringBuilderDay = ' <table width="100%" bgcolor="#FF6600" > <tr><td align="left" width="25%"><a style="color: white;"  x-blackberry-focusable= "true" onmouseover = "this.className = \'aclick-hover\'" onmouseout = "this.className = \'aclick\'"  onclick="paginationDay(\'2012-7-11\');" class= "aclick" >&nbsp;&laquo;&nbsp;Ayer</a></td><td align="center" width="50%" style="color: white;">'+day+'-'+month+'</td><td width="25%" align="right"></td></tr></table> ';
		}else if(stringDate == '2012-7-27' ){
			stringBuilderDay = '<table width="100%" bgcolor="#FF6600" > <tr><td align="left" width="25%"></td><td align="center" width="50%" style="color: white;">'+day+'-'+month+'</td><td width="25%" align="right"> <a style="color: white;"  x-blackberry-focusable= "true" onmouseover = "this.className = \'aclick-hover\'" onmouseout = "this.className = \'aclick\'" onclick="paginationDay(\'2012-6-28\');" class= "aclick">Ma&ntilde;ana&nbsp;&raquo;&nbsp;</a> </td></tr></table>';
			...
			date.setDate(date.getDate()-1);
			stringBuilderDay = '<table width="100%" bgcolor="#FF6600" > <tr><td align="left" width="25%"><a style="color: white;"  x-blackberry-focusable= "true" onmouseover = "this.className = \'aclick-hover\'"'+ 
				'onmouseout = "this.className = \'aclick\'"  onclick="paginationDay(\''+stringBackDay+'\');" class= "aclick" >&laquo;&nbsp;Ayer</a></td><td align="center" width="50%" style="color: white;">'+day+'-'+month+'</td><td width="25%" align="right">'+
				'<a style="color: white;"  x-blackberry-focusable= "true" onmouseover = "this.className = \'aclick-hover\'" onmouseout = "this.className = \'aclick\'" style="color: white;"   onclick="paginationDay(\''+stringNextDay+'\');" class= "aclick">Ma&ntilde;ana&nbsp;&raquo; </a></td></tr></table>';
		}
...
//function getUpdateCalendar(list){
//	
//
//	document.getElementById('load-calendar').innerHTML = "<img id='loading' alt='Cargando' src='images/loading1.gif' />Cargando....";
//	var element = document.getElementById("calendarioListId");
...
//	console.log(flagDisc+"--------- "+flagVenCalen);
//	console.log(list);
//		for( var i in list){
//			if(flagDisc == "" || flagDisc == list[i].iddisc ){
//				if(flagVenCalen  || list[i].vzla == '1' ){
//					console.log("true");
//					tr = document.createElement('tr');
//					table.appendChild(tr);
//					if(i % 2 == 0)
...
//					var tdLabel1 = document.createElement('td');
//					tr.appendChild(tdLabel1);
//					tdLabel1.innerHTML = ''+list[i].hora;
//					tdLabel1 = document.createElement('td');
//					tr.appendChild(tdLabel1);
...
//					tr.appendChild(tdLabel1);
//					tdLabel1.setAttribute('class','center');
//					tdLabel1.innerHTML = ''+list[i].categoria;
//				}
//			}
//			
//		}
...
function makeTableCalendar(list){
	...
	thLabel = document.createElement('th');
	tr.appendChild(thLabel);
	thLabel.innerHTML = 'G&eacute;nero/Categor&iacute;a';
